...
# ### OMP P1 ###
# numgen_n='./script/numgen/numgen3 1 250000'       # input size
# numgen_t='./script/numgen/numgen3 1 2048'            # thread count
...
# ./script/graph/omp_p1_ops.sh "./result/$recFile" "./result/$iteFile" "./result/$hilFile" "./result/$totFile" "$n" "./$target/omp_p1_ops_$n.jpg"
...
# ## OMP P2 ###
# numgen_m='./script/numgen/numgen 1 3000'       # input size m
# numgen_n='./script/numgen/numgen 1 3000'       # input size n
